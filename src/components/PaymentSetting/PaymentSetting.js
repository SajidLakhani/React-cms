      ...
      <div className = {classes.Tablemain}>
       <div className = {classes.innerDiv}>
         ...
         {data.map((item)=>(
            ...
            <p className={classes.forText} style ={{marginLeft:'-25px'}} >{item.name}</p>
            <p className={classes.forText} style ={{marginLeft:'-25px'}} >{item.location}</p>
            <p className={classes.forText} >{item.amount}</p>
            <p className={classes.forText} >{item.date}</p>
            <p className={classes.forText} >{item.time}</p>
