...
const ManufacturerReturn = () => {
  ...
  return (
    <div style ={{padding:'40px 20px', fontFamily:'MyFirstFont'}}>
      <h1 style ={{margin:'5px 0'}}>Manufacturer Return</h1>
     
      <Card className = {classes.forCard}>
        <h2 style ={{margin:'10px 0'}}>Manufacturer Return List</h2>
...
export default ManufacturerReturn;