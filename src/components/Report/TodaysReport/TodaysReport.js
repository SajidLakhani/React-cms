...
const TodaysReport = () => {
  ...
  return (
    <div style ={{padding:'40px 20px', fontFamily:'MyFirstFont'}}>
      <h1 style ={{margin:'5px 0'}}>Todays Report</h1>
     
      <Card className = {classes.forCard}>
        <h2 style ={{margin:'10px 0'}}>Todays Sales Report </h2>
      ...
      <Card className = {classes.forCard}>
        <h2 style ={{margin:'10px 0'}}>Todays Purchase Report </h2>
      <div className = {classes.Tablemain}>
       <div className = {classes.innerDiv}>
         <div className = {classes.forHeadings}>
         <h3 className={classes.forText}>Purchase Date</h3>
         <h3 className={classes.forText}>Invoice Number</h3>
         <h3  className={classes.forText}>Manufacturer Name</h3>
         <h3  className={classes.forText}>Total Amount</h3>
         </div>
         {data.map((item)=>(
            <div className = {classes.forAll}>
